...
export default function PlacesNearYou() {
                ...
                <div className="desktop">
                    <div className={headerStyle.headBody1}>
                        ...
                        <div className={headerStyle.headUpNavMain}>
                            ...
                            <div className={headerStyle.headUpNavMain1}><img src={rightArrowIcon} alt="" /></div>
                    ...
                    <div className="PlacesNearYou0">
                        <div className="PlacesNearYou01">{places.length} Stay</div>
                        <div className="PlacesNearYou02">Places near you</div>
                    ...
                    <div className="DetailListCont">
                        ...
                        {/* single container  to="/hotelInfo"*/}

                        {places.map(val => {return (
                                ...
                                <div className="DetailList02">
                                    <div className="DetailList02Side0">
                                        <div className="DetailList02Side01">
                                            <div className="DetailList021" onClick={() => history.push(`/hotelInfo/${val.id}`)}>User Name {val.userId}</div>
                                            <div className="DetailList022" onClick={() => history.push(`/hotelInfo/${val.id}`)}>{val.listingTitle}</div>
                                        </div>
                                        <div className="DetailList02Side02" onClick={() => alert("Saved in your fav list")}>
                                            <img src={favIcon} alt="" />
                                        </div>
                                    </div>
                    ...
                    <div className="placesNearMob1">
                        ...
                        <div className="placesNearMob12">
                            ...
                            {places.map(val => {return (
                                ...
                                <Link to={{pathname: `/hotelInfo/${val.id}`}}  className="placesNearMob121">
                                    <img src={v1} alt="" />
                        ...
                        <div className="headingMobile04">
                            <div className="headingMobile042">
                                <div className="headingMobile0421">
                                  ...
                                  a nhyumb7tfv6rc  <div className="headingMobile061">
                            ...
                            <div className="PlacesNearYou911">
                                ...
                                <div className="PlacesNearYou9111">
                                    ...
                                    <div className="PlacesNearYou91112">
                                        <div className="PlacesNearYou911111">Entire Home</div>
                ...
                {topBar && (
                    <>
                        <div className={headerStyle.topBar0}>
                            ...
                            <div className={headerStyle.topBar1} onClick={() => setTopBar(false)}></div>
